...
/** @file src/parser.c
 * A parser for SpreadModel herd status snapshot files.
 *
 ...
 * any later version.
 *
 * @todo Create an XML format for the herd file and move this parser to a
 *   separate program that will convert from SpreadModel files.
 */

/** @page fileformat Herd status snapshot file format
 * The first line is a header line.
 * It contains the following field names, separated by commas, in this order:
 * <ul>
 *   <li>\em LivestockClass
 *   <li>\em HerdSize
 *   <li>\em Lat
 *   <li>\em Lon
 *   <li>\em Status
...
%token LIVESTOCKCLASS HERDSIZE LAT LON STATUS DINSTATUS DLINSTATUS
...
header :
    LIVESTOCKCLASS COMMA HERDSIZE COMMA LAT COMMA LON COMMA
    STATUS COMMA DINSTATUS COMMA DLINSTATUS COMMA exposure_fields_list COMMA
    HOWINFECTED COMMA DSINCEDET COMMA DSINCEVAC COMMA
    HOLDFOR COMMA HOLDDAYS COMMA HOLDPRIORITY
    {
      ntracked_exposures = $15;
      nfields = 6 + $15*3 + 6;
    }
  ;
...
herd:
    INT COMMA INT COMMA FLOAT COMMA FLOAT COMMA INT COMMA INT COMMA INT COMMA int_list
    {
      int length;
