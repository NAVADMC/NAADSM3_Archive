...
typedef struct
{
    /*  These are handled by change_herd_state */
    ...
    /*  These are handled by infect_herd */
    ...
    /*  These are handled by vaccinate_herd */
...
typedef struct
{
  ...
  /**  daily counts for destruction handled by destroy_herd*/
...
typedef struct
{
  ...
  HRD_production_type_data_t *production_type;
